...
function getCookieValue($name) {
   $args=func_get_args();
   return _getRQValue($_COOKIE, $args);
}
...
function getRequestValue($name) {
   $args=func_get_args();
   return _getRQValue($_REQUEST, $args);
}
 ...
 * @return mixed|string
 */
function _getRQValue($superarray, $params) {
